...
<head>
  <meta charset="UTF-8">
  <title>Dashboard | Defect Items</title>
...
<%@include file="logged_header.jsp" %>
  ...
  <aside id="sidenav-open" class="h-screen">
    <nav class="flex flex-col justify-between h-full p-5 border-r bg-gray-50">
      <div>
        ...
        <a href="defect_item.jsp" class="flex items-center p-3 rounded-xl bg-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 w-7 text-gray-900" fill="currentColor"
            viewBox="0 0 16 16">
  ...
  <main class="overflow-y-scroll h-screen">
    ...
    <span><form class="ml-5" method="POST" action="../Defect_itemServlet">
        ...
        <br><br>
        <label for="qty">Warehouse ID: </label>
        <input type="text" name="wid" class="form-control" id="wid" placeholder="Enter Warehouse ID" required><br>
