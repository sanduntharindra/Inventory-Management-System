...
<%@include file="logged_header.jsp" %>
  ...
  <aside id="sidenav-open" class="h-screen">
    <nav class="flex flex-col justify-between h-full p-5 border-r bg-gray-50">
      <div>
        ...
        <a href="stock_availability.jsp" class="flex items-center p-3 rounded-xl hover:bg-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 w-7 text-gray-900" fill="currentColor"
            viewBox="0 0 16 16">
            <path
        ...
        <a href="orders.jsp" class="flex items-center p-3 rounded-xl bg-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 w-7 text-gray-900" fill="currentColor"
            viewBox="0 0 16 16">
            <path
  ...
  <main class="overflow-y-scroll h-screen">
    ...
    <span><form class="ml-5" method="POST" action="../OrdersServlet">
        <br><label for="ordid">ORDER ID:</label>
        <input type="text" name="ordid" class="form-control" id="stid" placeholder="Enter Order ID" required><br>
        ...
        <br><label for="qty">Quantity:</label>
    ...
    <%
        ...
        <table align="center" cellpadding="5" cellspacing="1" border="0">
            ...
            <tr bgcolor="#D6EAF8" class="text-center">
                ...
                <td><%=resultSet.getString("o_id") %></td>
                <td><%=resultSet.getString("o_type") %></td>
                <td><%=resultSet.getString("o_prodname") %></td>
                <td><%=resultSet.getString("o_qty") %></td>
                <td><%=resultSet.getString("o_date") %></td>
